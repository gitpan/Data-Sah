...
# return a shallow copy of the original hash.
sub normalize_clset {
    my $self;
...
sub normalize_schema {
    ...
    if (!defined($s)) {
        ...
        my $clset = $self->normalize_clset($clset0, {has_req=>$has_req});
        if (defined $extras) {
...
This document describes version 0.27 of Data::Sah (from Perl distribution Data-Sah), released on 2014-05-04.
